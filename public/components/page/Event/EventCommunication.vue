...
<style>
select#envoiKitCom:has(option[value="1"]:checked), select#envoiKitCom option[value="1"] {
    background-color:#F9CB9C;
    color:#AC4A00;
}
select#envoiKitCom:has(option[value="2"]:checked), select#envoiKitCom option[value="2"] {
