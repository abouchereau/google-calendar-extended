        ...
        <div class="card-body">                        
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-sm-12 py-1">
                    ...
                    <textarea rows="5" :disabled="!editable" id="precisions" v-model="$main.item.precisions" class="form-control" />  
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-12 py-1" @keyup.enter="$emit('targetHeureDepart')">
                    <label v-if="editable">&nbsp;</label>
                    <button v-if="editable" class="btn btn-success w-100" @click="$emit('targetHeureDepart')">Calculer l'heure de RDV</button>
                    <label v-if="editable || $main.item.heureArrivee">Heure Arrivée</label>
                    <input v-if="editable || $main.item.heureArrivee" :disabled="!editable" id="heureArrivee" type="time" step="300" v-model="$main.item.heureArrivee" class="form-control" @blur="$emit('targetHeureDepart')"/>
                </div>                
                <div class="col-xl-3 col-lg-4 col-sm-12 py-1" v-if="editable || $main.item.heureBalance">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-12 py-1" v-if="editable || $main.item.heureRdvRepas">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-12 py-1" v-if="editable || $main.item.heureDebutConcert">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-12 py-1" v-if="editable || $main.item.heureRetour">
